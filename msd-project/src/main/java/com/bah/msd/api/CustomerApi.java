...
public class CustomerApi {
	...
	public ResponseEntity<?> addCustomer(@RequestBody Customer newCustomer, UriComponentsBuilder uri) {
		...
		//  entity as a URI.
		if ((newCustomer.getEmail() == null) || newCustomer.getName() == null || newCustomer.getId() != 0L) {
	...
	public Customer lookupCustomerByNameGet(@PathVariable("username") String username,
	...
	@PostMapping("/byname")
	public Customer lookupCustomerByNamePost(@RequestBody String username, UriComponentsBuilder uri) {
